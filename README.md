...
> [!TIP]
> Der Name des Interfaces (oben links zu sehen) kann in der `index.html` in `/app/templates/` geändert werden.

> [!TIP]
> Zur Verwendung eines Favicons muss dieses als `favicon.ico` in `/app/static/` abgelegt werden.
